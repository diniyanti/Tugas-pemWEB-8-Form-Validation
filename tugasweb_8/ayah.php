		...
		<div class="card-body">
			<form method="POST" action="simpan_ayah.php" >
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="nama_ayah" class="form-control"  placeholder="Nama Ayah Kandung" required="">
					</div>
				</div>
				<!-- Tahun Lahir Ayah -->
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="date" name="thn_lahir_ay" class="form-control" required="">
					</div>
				</div>
				<!-- Pendidikan Ayah-->
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pendidikan_ay" class="form-control" required="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="pekerjaan_ay" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="penghasilan_ay" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="kebutuhan_khusus_ay" class="form-control" required="">
							<option selected disabled value="">-- Pilih --</option>
